...
## 2026-03-24 - Simulation End-States
**Learning:** Abruptly terminating an application upon reaching an end-state (like population extinction) deprives the user of the final visual context and forces a sudden exit.
