...
**Learning:** Abruptly closing an application upon reaching an end-state (like extinction) prevents users from viewing final statistics or processing what happened.
