...
## 2026-03-06 - Final Context Preservation
**Learning:** Abruptly terminating an application on an end-state (like extinction) frustrates users who want to review the final system state.
