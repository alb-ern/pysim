...
def main():
    ...
    while running:
        ...
        stats = [
            ...
            f"(Press ESC to Exit)" if extinct else f"(SPACE to {'Resume' if paused else 'Pause'})"
        ]
        ...
        if len(agents) == 0 and not extinct:
            print("Extinction!")
            extinct = True
            paused = False # Ensure we don't display "PAUSED" text
        ...
        if paused:
            ...
            overlay = large_font.render("EXTINCT", True, (255, 100, 100))
