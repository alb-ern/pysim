...
def main():
    ...
    while running:
        ...
        if extinct:
            status_text = "EXTINCT"
            control_text = "(ESC to Quit)"
        elif paused:
            status_text = "PAUSED"
            control_text = "(SPACE to Unpause)"
        else:
            status_text = "RUNNING"
            control_text = "(SPACE to Pause)"
        ...
        if paused:
            ...
            overlay_text = "EXTINCTION" if extinct else "PAUSED"
            ...
            if extinct:
                subtitle = font.render("Press ESC to quit", True, (200, 200, 200))
                subtitle_rect = subtitle.get_rect(center=(width * tile_size // 2, height * tile_size // 2 + 50))
