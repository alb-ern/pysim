...
def main():
    ...
    while running:
        ...
        prompt_text = "(ESC to Exit)" if extinct else "(SPACE to Pause)"
        stats = [
        ...
        if paused:
            ...
            sub_text_str = "Press ESC to exit" if extinct else "Press SPACE to resume"
            sub_text = font.render(sub_text_str, True, (200, 200, 200))
