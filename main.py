...
def main():
    ...
    while running:
        ...
        # Render stats
        toggle_label = "(ESC to Exit)" if extinct else ("(SPACE to Resume)" if paused else "(SPACE to Pause)")
        status_label = "EXTINCT" if extinct else ("PAUSED" if paused else "RUNNING")
