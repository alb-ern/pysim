...
def main():
    ...
    while running:
        ...
        stats = [
            ...
            "(ESC to Exit)" if extinct else ("(SPACE to Resume)" if paused else "(SPACE to Pause)")
        ]
        ...
        if paused or extinct:
            ...
            text_str = "EXTINCT" if extinct else "PAUSED"
            color = (255, 50, 50) if extinct else (255, 255, 255)
            overlay = large_font.render(text_str, True, color)
