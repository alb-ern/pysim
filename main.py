...
def main():
    ...
    while running:
        ...
        # Render stats
        status_str = "EXTINCT" if extinct else ("PAUSED" if paused else "RUNNING")
        action_str = "(ESC to Exit)" if extinct else ("(SPACE to Resume)" if paused else "(SPACE to Pause)")
        ...
        if paused or extinct:
            ...
            text_to_render = "EXTINCT" if extinct else "PAUSED"
            overlay = large_font.render(text_to_render, True, (255, 255, 255))
