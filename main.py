...
def main():
    ...
    # Pre-allocate pause dim overlay
    dim_overlay = pg.Surface((width * tile_size, height * tile_size), pg.SRCALPHA)
    ...
    while running:
        ...
        if show_hud:
            ...
            bg_surface.fill((0, 0, 0, 180)) # Darkened for better contrast
