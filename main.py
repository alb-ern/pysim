...
def main():
    ...
    while running:
        ...
        help_text = "(ESC to Exit)" if extinct else "(SPACE to Pause)"
        stats = [
        ...
        if paused or extinct:
            ...
            overlay_color = (255, 50, 50) if extinct else (255, 255, 255)
            overlay = large_font.render(overlay_text, True, overlay_color)
